class ResizeGrid {
  constructor(colorPicker) {
    ...
    this._element.className = "inputDiv sideBar";
    ...
    this.resizeBtn.addEventListener("click", () => {
      ...
      let gridContainer = new GridContainer(Number(this._xDimInput.value), Number(this._yDimInput.value));
      let grid = new Grid(Number(this._xRows.value), Number(this._yRows.value), gridContainer.element);
